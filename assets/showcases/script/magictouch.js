...
var tuio = {
  ...
  _get_target_touches: function(element) {
    ...
    data.identifier = sid;
    data.pageX = window.innerWidth * x +window.pageXOffset; //changed: add scroll offset
    data.pageY = window.innerHeight * y +window.pageYOffset; // changed: add scroll offset
