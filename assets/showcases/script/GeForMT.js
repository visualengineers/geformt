...
var GeForMT = (function(){
    ...
    /**
     * Feedforward module.
     * @type GeForMT.Feedforward
     * @default null
     */
    var _feedforwardModule = null;
    var _stopH = false;
    /**
    ...
    function _gestureRecognized(e){
        ...
        // stop gesture handler for animation
        if (!_stopH)
            gesture.handler(e);    
    }
    
    function _setFeedforward(){
        _feedforwardModule = GeForMT.Feedforward;
        _feedforwardModule.init(_observationModule, _recognitionModule);
    }
    ...
    return {
        ...
        /**
         * Start feedforward module        
         */
        initFeedforward: function(){
          _setFeedforward();  
        },
        stopHandler: function(bool){
            _stopH = bool;
        }
    };
})();
